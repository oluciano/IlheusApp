...
-- Documentação DDL para referência
-- =============================================================================
-- Valores monetários SEMPRE em centavos (INTEGER) — nunca REAL/FLOAT
-- mes_ano SEMPRE no formato MM/YYYY
-- Casa inativa (vazia) ainda paga componentes fixos (esgoto, servico basico,
-- luz, cond) — apenas água é zero (sem consumo)
-- =============================================================================
...
-- ---------------------------------------------------------------------------
-- 1. casas
-- Cada casa residencial (1-22) + quiosque (23)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 4. configuracao_mes
-- Configurações administrativas por mês
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 5. leituras
-- Leituras mensais de hidrômetro por casa
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 6. evento_uso_quiosque
-- Registro de quais casas usaram o quiosque no mês
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 7. fatura_calculada
-- Fatura gerada pelo administrador
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 8. cobrancas
-- Cobrança detalhada por casa para uma fatura
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 10. debitos
-- Débitos em aberto de meses anteriores
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Trigger: auto-update updated_at em fatura_calculada
-- ---------------------------------------------------------------------------
